...
import DaejeonList from './DaejeonList';
const styles = theme => ({
    root: {
        width: "100%",
    ...
    render() {
        ...
        return (
            <div>
                <div>
                    <br/>
                    {`현재 대전 확진자 ${this.state.number.확진자}명 검사중 ${this.state.number.검사중}명 격리중 ${this.state.number.격리중}명 격리해제 ${this.state.number.격리해제}명 사망자 ${this.state.number.사망자}명`}
                    <br/>
...
export default withStyles(styles)(DaeJeon);